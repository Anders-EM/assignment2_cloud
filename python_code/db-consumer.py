...
consumer = KafkaConsumer(bootstrap_servers="192.168.5.8:9092")

# subscribe to topic
consumer.subscribe(topics=["iot"])

couchdb_url = "http://127.0.0.1:5984/test-db"
username = "admin"  # CouchDB admin username
password = "cloud-cookie"  # CouchDB admin password
